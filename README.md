...
# Special note for Mac Apple Silicon

1. brew install ruby@3.1
2. export PATH="/opt/homebrew/opt/ruby@3.1/bin:$PATH"
3. export PATH="/opt/homebrew/lib/ruby/gems/3.1.0/bin:$PATH"
4. gem install jekyll bundle
5. bundle clean --force
6. bundle install
